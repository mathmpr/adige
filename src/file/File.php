...
class File
{
    ...
    public function __construct($location)
    {
        ...
        array_pop($location);
        $this->directory = new Directory(join('/', $location), true);
        if ($this->exists()) {
    ...
    {
        return static::$mimeMap[$mime] ?? false;
    }

    public static function ext2mime(string $extension): ?string
    {
        foreach (static::$mimeMap as $key => $value) {
